...
public class InstructorDetailsFragment extends Fragment {
    ...
    private TextView textViewInstructorDetails;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_instructor_details, container, false);
        textViewInstructorDetails = view.findViewById(R.id.textViewInstructorDetails);
        ...
        textViewInstructorDetails.setText(detailsContent);
